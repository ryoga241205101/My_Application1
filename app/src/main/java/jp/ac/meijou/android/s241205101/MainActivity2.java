                ...
                switch (result.getResultCode()) {
                    case RESULT_OK -> {
                        Optional.ofNullable(result.getData())
                                ...
                                .ifPresent(text -> binding.editTextText3.setText(text));
                    }
                    case RESULT_CANCELED -> {
                        binding.editTextText3.setText("Result: Canceled");
                    }
                    default -> {
                        binding.editTextText3.setText("Result: Unknown(" + result.getResultCode() + ")");
                    }
                }
            }
    );
